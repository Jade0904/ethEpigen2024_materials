...
dir.create("raw")
download.file("https://www.encodeproject.org/files/ENCFF014MOQ/@@download/ENCFF014MOQ.fastq.gz", dest="D:/ETH/FS2024/Epigen/ethEpigen2024_materials/week03/Myc.fastq.gz", mode = "wb")
download.file("https://www.encodeproject.org/files/ENCFF179TMO/@@download/ENCFF179TMO.fastq.gz", dest="D:/ETH/FS2024/Epigen/ethEpigen2024_materials/week03/input.fastq.gz", mode="wb")
```
...
qc <- lapply(c(Myc="Myc.fastq.gz", input="input.fastq.gz"), FUN=function(x){
