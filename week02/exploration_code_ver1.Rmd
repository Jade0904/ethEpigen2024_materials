...
g[1] # fetch the first gene

ex <- exons(ensdb) # fetch the exons
ex <- exonsBy(ensdb) # default by transcripts
head(ex)
...
gr <- as("2L:14615552-14616552", "GRanges") # alternatively?
gr <- GRanges("2L", # represents chromesome
              IRanges(start=c(14615552, 14616303),
                      end=c(14615552+10, 14616303+20)))
# alternatively
gr <- GRanges(seqnames = c("2L", "2L"),
              IRanges(start=c(14615552, 14616303),
                      end=c(14615552+10, 14616303+20)))
gr
